...
<meta http-equiv="Content-Type" content="text/html; charset=gb2312">
  <style type="text/css">
    ...
    .shadow{background-image:url(299_files/shadow.gif);background-position:center;background-repeat: no-repeat;height:610px;}  
...
<body bgcolor="#bfebff" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
...
<table cellpadding="0" cellspacing="0" border="0" align="center" width="100%" height="100%"> 
  <tr> 
    <td valign="middle" align="center">      
	  ...
	  <tr>
	    <td colspan="2"><img src="299_files/299_01.jpg" width="1005" height="416" alt=""></td>
	  </tr>
	  <tr>
	    <td><img src="299_files/299_02.jpg" width="400" height="220" alt=""></td>
	    <td width="605" height="220">
	      <table width="100%" height="220" cellspacing="0" cellpadding="0" border="0" background="299_files/299_03.jpg" >
	        <tr>		        
			...
			<td></td>
		        ...
		        <td align="center" valign="bottom" class="btnTd">
                          <p><input name="loginBtn" type="image" value="提交" src="299_files/button.gif" tabindex="3"></p>
			</td>
                      </tr>				     
		    </table>
		  </td>

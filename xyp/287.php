...
<meta http-equiv="Content-Type" content="text/html; charset=gb2312">
  <style type="text/css">
    ...
    .shadow{background-image:url(287_files/shadow.gif);background-position:center;background-repeat: no-repeat;height:610px;position: relative; }
	.sky1{  
    color: #EACA17;
	font-weight:bold;
	font-family: "黑体";
...
<form name="form1" method="post" action=""><input type="hidden" name="login" value="yes">
<table cellpadding="0" cellspacing="0" border="0" align="center" width="100%" height="100%"> 
  <tr> 
    <td valign="middle" align="center">     
	  ...
	  <tr>
	    <td colspan="2"><img src="287_files/287_01.jpg" width="1005" height="301" alt=""></td>
	  </tr>
      
	  <tr>
	    <td> <img src="287_files/287_02.jpg" width="400" height="345" alt=""></td>
	    <td width="605" height="345">
	      <table width="100%" height="345" cellspacing="0" cellpadding="0" border="0" background="287_files/287_03.jpg" >
	        <tr>		        
		    ...
		    <table width="384" height="113" cellspacing="0" cellpadding="0" border="0" >
		      ...
		      <tr>
			    ...
			    <input name="user" type="text" class="inputBlock" tabindex="1">	
                      ...
                      <tr>
			<td height="12" class="style6" align="center"></td> 
		        <td></td>
		        <td></td>
		      </tr> 
		      <tr>
			...
			<td></td>
		        ...
		        <td align="center" valign="bottom" class="btnTd">
                          <p><input name="loginBtn" type="image" value="提交" src="287_files/button.gif" tabindex="3"></p>
			</td>
                      </tr>				     
		    </table>
		  </td>
